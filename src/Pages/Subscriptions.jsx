	...
	const fetchsubscriptions = async () => {
		try {
			...
			if (res) {
				console.log(
					"data of subscribers",
					res.data.message.subscribed
				);

				setchannels(res.data.message.subscribed);
			}
		} catch (error) {
			console.log(error);
	...
	return (
		<div>
			<section class=" flex flex-wrap ">
				<div class="mx-auto mb-8 max-w-screen ">
				...
				<div class=" w-screen text-center flex justify-center items-center  ">
					{channels.map((ch) => (
						<>
							<div class="grid gap-2 lg:gap-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2">
								<div class="text-center text-ghost">
									...
									<h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
										<a href="#">
											{ch.subscribedchannels?.username}
										</a>
									</h3>
									<p>CEO/Co-founder</p>
